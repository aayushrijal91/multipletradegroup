    ...
    <nav class="container">
        <div class="flex flex-wrap justify-center md:justify-between items-center gap-y-5">
            ...
            <div class="w-fit flex flex-wrap items-center gap-x-3">
                <div class="w-fit">
                    <a href="tel:<?= $phone_number ?>" class="h-[60px] bg-dark text-white font-bold text-lg rounded-full flex items-center px-7">Book Today</a>
                </div>
                <div class="w-fit">
            ...
            <form action="" id="form" class="flex flex-wrap gap-y-5 mt-10 md:mt-14">
                ...
                <div class="w-full md:w-1/2 px-2">
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" name="phonenumber" placeholder="Phone" required />
                    </div>
                </div>
