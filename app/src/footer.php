<footer class="bg-[#131313] py-4">
	<div class="container">
		<div class="flex flex-wrap items-center justify-center md:justify-between gap-y-5">
			<div class="w-full md:w-fit">
				<p class="text-[#A8A8B4] text-sm text-center md:text-start">Copyright <?= date('Y') ?> <span class="px-3 lg:px-5">|</span> <?= $site ?> <span class="px-3 lg:px-5">|</span> All Rights Reserved</p>
			</div>
			<div class="w-fit">
